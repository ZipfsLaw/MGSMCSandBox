...
DWORD WINAPI Start(LPVOID lpParam)
{
	...
	ReplaceText(0x8945E0, "XM16E1:\nA modified variant of the original\nM16 which featured improvements\nsuch as forward assist and chrome\nbolt carrier.", 124);
	...
	ReplaceText(0x88C280, "Stun Grenade:\nA grenade that produces a blinding\nflash of light and an extremely loud\nbang, disorienting enemy senses.", 125);
